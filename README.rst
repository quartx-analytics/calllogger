...
.. code-block:: bash
    ...
    docker run --detach --name "calllogger" -e "TOKEN=<token>" -e "PLUGIN=SiemensHipathSerial" --device=/dev/ttyUSB0:/dev/ttyUSB0 --volume="calllogger-data:/data" --restart=unless-stopped --network host ghcr.io/quartx-analytics/calllogger
